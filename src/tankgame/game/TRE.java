...
public class TRE extends JPanel implements Runnable {
    ...
    private Tank t1, t2;
    private Vector2 spawnPos1 = new Vector2(30, 30), spawnPos2 = new Vector2(920, 500);
    ...
    public void gameInitialize() {
        ...
        try {
            ...
            InputStreamReader isr = new InputStreamReader(TRE.class.getClassLoader().getResourceAsStream("Maps/map"));
            ...
            for (int i = 0; i < numRows; i++) {
                ...
                for (int j = 0; j < numCols; j++) {
                    ...
                    switch (mapInfo[j]) {
                        case "2":
                            Wall w = new Wall(pos, walls, breakWalls);
                            w.setBreakable(true);
                            listWalls.add(w);
                            break;
                        case "3":
                            Wall w2 = new Wall(pos, walls, breakWalls);
                            w2.setBreakable(false);
                            listWalls.add(w2);
                        case "9":
                            Wall w3 = new Wall(pos, walls, breakWalls);
                            w3.setBreakable(false);
                            w3.collision_wall = false;
                            listWalls.add(w3);
                            break;
                    }
                }
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.scale(0.2, 0.2);
        g2.drawImage(miniMap,(28 * 5), 470 * 5,null);
